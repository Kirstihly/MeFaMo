...
class BlendshapeCalculator:
    ...
    def _calculate_mouth_landmarks(self, no_filter=False):
        upper_lip = self._get_landmark(
            self.blend_shape_config.CanonicalPpoints.upper_lip
        )
        upper_outer_lip = self._get_landmark(
            self.blend_shape_config.CanonicalPpoints.upper_outer_lip
        )
        lower_lip = self._get_landmark(
            self.blend_shape_config.CanonicalPpoints.lower_lip
        )

        mouth_corner_left = self._get_landmark(
            self.blend_shape_config.CanonicalPpoints.mouth_corner_left
        )
        mouth_corner_right = self._get_landmark(
            self.blend_shape_config.CanonicalPpoints.mouth_corner_right
        )
        lowest_chin = self._get_landmark(
            self.blend_shape_config.CanonicalPpoints.lowest_chin
        )
        nose_tip = self._get_landmark(self.blend_shape_config.CanonicalPpoints.nose_tip)
        upper_head = self._get_landmark(
            self.blend_shape_config.CanonicalPpoints.upper_head
        )
        ...
        mouth_smile_left = 1 - self._remap_blendshape(
            FaceBlendShape.MouthSmileLeft, smile_left
        )
        mouth_smile_right = 1 - self._remap_blendshape(
            FaceBlendShape.MouthSmileRight, smile_right
        )
        ...
        mouth_frown_left = (
            mouth_corner_left
            - self._get_landmark(
                self.blend_shape_config.CanonicalPpoints.mouth_frown_left
            )
        )[1]
        mouth_frown_right = (
            mouth_corner_right
            - self._get_landmark(
                self.blend_shape_config.CanonicalPpoints.mouth_frown_right
            )
        )[1]
        self._live_link_face.set_blendshape(
            FaceBlendShape.MouthFrownLeft,
            1 - self._remap_blendshape(FaceBlendShape.MouthFrownLeft, mouth_frown_left),
            no_filter,
        )
        self._live_link_face.set_blendshape(
            FaceBlendShape.MouthFrownRight,
            1
            - self._remap_blendshape(FaceBlendShape.MouthFrownRight, mouth_frown_right),
            no_filter,
        )

        # todo: also strech when laughing, need to be fixed
        mouth_left_stretch_point = self._get_landmark(
            self.blend_shape_config.CanonicalPpoints.mouth_left_stretch
        )
        mouth_right_stretch_point = self._get_landmark(
            self.blend_shape_config.CanonicalPpoints.mouth_right_stretch
        )
        ...
        stretch_normal_left = -0.7 + (0.42 * mouth_smile_left) + (0.36 * mouth_left)
        stretch_max_left = -0.45 + (0.45 * mouth_smile_left) + (0.36 * mouth_left)

        stretch_normal_right = -0.7 + 0.42 * mouth_smile_right + (0.36 * mouth_right)
        stretch_max_right = -0.45 + (0.45 * mouth_smile_right) + (0.36 * mouth_right)

        self._live_link_face.set_blendshape(
            FaceBlendShape.MouthStretchLeft,
            self._remap(mouth_left_stretch, stretch_normal_left, stretch_max_left),
            no_filter,
        )
        self._live_link_face.set_blendshape(
            FaceBlendShape.MouthStretchRight,
            self._remap(mouth_right_stretch, stretch_normal_right, stretch_max_right),
            no_filter,
        )
        ...
        self._live_link_face.set_blendshape(
            ...
            1 - self._remap_blendshape(FaceBlendShape.JawLeft, jaw_right_left),
            no_filter,
        )
        self._live_link_face.set_blendshape(
            FaceBlendShape.JawRight,
            self._remap_blendshape(FaceBlendShape.JawRight, jaw_right_left),
            no_filter,
        )

        lowest_lip = self._get_landmark(
            self.blend_shape_config.CanonicalPpoints.lowest_lip
        )
        under_lip = self._get_landmark(
            self.blend_shape_config.CanonicalPpoints.under_lip
        )

        outer_lip_dist = math.dist(lower_lip, lowest_lip)
        upper_lip_dist = math.dist(upper_lip, upper_outer_lip)

        mouth_pucker = self._remap_blendshape(FaceBlendShape.MouthPucker, mouth_width)
        self._live_link_face.set_blendshape(
            FaceBlendShape.MouthPucker, 1 - mouth_pucker, no_filter
        )
        self._live_link_face.set_blendshape(
            FaceBlendShape.MouthRollLower,
            1 - self._remap_blendshape(FaceBlendShape.MouthRollLower, outer_lip_dist),
            no_filter,
        )
        self._live_link_face.set_blendshape(
            FaceBlendShape.MouthRollUpper,
            1 - self._remap_blendshape(FaceBlendShape.MouthRollUpper, upper_lip_dist),
            no_filter,
        )
        ...
        self._live_link_face.set_blendshape(
            ...
            - self._remap_blendshape(
                FaceBlendShape.MouthShrugUpper, upper_lip_nose_dist
            ),
            no_filter,
        )

        over_upper_lip = self._get_landmark(
            self.blend_shape_config.CanonicalPpoints.over_upper_lip
        )
        ...
        self._live_link_face.set_blendshape(
            ...
            1
            - self._remap_blendshape(FaceBlendShape.MouthShrugLower, mouth_shrug_lower),
            no_filter,
        )

        lower_down_left = (
            math.dist(self._get_landmark(424), self._get_landmark(319))
            + mouth_open_dist * 0.5
        )
        lower_down_right = (
            math.dist(self._get_landmark(204), self._get_landmark(89))
            + mouth_open_dist * 0.5
        )
        ...
        self._live_link_face.set_blendshape(
            ...
            1
            - self._remap_blendshape(
                FaceBlendShape.MouthLowerDownLeft, lower_down_left
            ),
            no_filter,
        )
        self._live_link_face.set_blendshape(
            ...
            1
            - self._remap_blendshape(
                FaceBlendShape.MouthLowerDownRight, lower_down_right
            ),
            no_filter,
        )
        ...
        if self._live_link_face.get_blendshape(FaceBlendShape.MouthPucker) < 0.5:
            self._live_link_face.set_blendshape(
                ...
                1 - self._remap_blendshape(FaceBlendShape.MouthFunnel, mouth_width),
                no_filter,
            )
        else:
            self._live_link_face.set_blendshape(
                FaceBlendShape.MouthFunnel, 0, no_filter
            )

        left_upper_press = math.dist(
            self._get_landmark(
                self.blend_shape_config.CanonicalPpoints.left_upper_press[0]
            ),
            self._get_landmark(
                self.blend_shape_config.CanonicalPpoints.left_upper_press[1]
            ),
        )
        left_lower_press = math.dist(
            self._get_landmark(
                self.blend_shape_config.CanonicalPpoints.left_lower_press[0]
            ),
            self._get_landmark(
                self.blend_shape_config.CanonicalPpoints.left_lower_press[1]
            ),
        )
        ...
        right_upper_press = math.dist(
            self._get_landmark(
                self.blend_shape_config.CanonicalPpoints.right_upper_press[0]
            ),
            self._get_landmark(
                self.blend_shape_config.CanonicalPpoints.right_upper_press[1]
            ),
        )
        right_lower_press = math.dist(
            self._get_landmark(
                self.blend_shape_config.CanonicalPpoints.right_lower_press[0]
            ),
            self._get_landmark(
                self.blend_shape_config.CanonicalPpoints.right_lower_press[1]
            ),
        )
        ...
        self._live_link_face.set_blendshape(
            ...
            1 - self._remap_blendshape(FaceBlendShape.MouthPressLeft, mouth_press_left),
            no_filter,
        )
        self._live_link_face.set_blendshape(
            FaceBlendShape.MouthPressRight,
            1
            - self._remap_blendshape(FaceBlendShape.MouthPressRight, mouth_press_right),
            no_filter,
        )
    ...
    def _eye_lid_distance(self, eye_points):
        eye_width = math.dist(
            self._get_landmark(eye_points[0]), self._get_landmark(eye_points[1])
        )
        eye_outer_lid = math.dist(
            self._get_landmark(eye_points[2]), self._get_landmark(eye_points[5])
        )
        eye_mid_lid = math.dist(
            self._get_landmark(eye_points[3]), self._get_landmark(eye_points[6])
        )
        eye_inner_lid = math.dist(
            self._get_landmark(eye_points[4]), self._get_landmark(eye_points[7])
        )
    ...
    def _calculate_eye_landmarks(self, no_filter=False):
        ...
        def get_eye_open_ration(points):
            ...
            max_ratio = 0.285
            ratio = np.clip(eye_distance / max_ratio, 0, 1)
            return ratio

        eye_open_ratio_left = get_eye_open_ration(
            self.blend_shape_config.CanonicalPpoints.eye_left
        )
        eye_open_ratio_right = get_eye_open_ration(
            self.blend_shape_config.CanonicalPpoints.eye_right
        )

        blink_left = 1 - self._remap_blendshape(
            FaceBlendShape.EyeBlinkLeft, eye_open_ratio_left
        )
        blink_right = 1 - self._remap_blendshape(
        ...
        self._live_link_face.set_blendshape(
            ...
            self._remap_blendshape(FaceBlendShape.EyeWideLeft, eye_open_ratio_left),
            no_filter,
        )
        self._live_link_face.set_blendshape(
            FaceBlendShape.EyeWideRight,
            self._remap_blendshape(FaceBlendShape.EyeWideRight, eye_open_ratio_right),
            no_filter,
        )
        ...
        self._live_link_face.set_blendshape(
            ...
            1 - self._remap_blendshape(FaceBlendShape.EyeSquintLeft, squint_left),
            no_filter,
        )

        squint_right = math.dist(
            self._get_landmark(
                self.blend_shape_config.CanonicalPpoints.squint_right[0]
            ),
            self._get_landmark(
                self.blend_shape_config.CanonicalPpoints.squint_right[1]
            ),
        )
        self._live_link_face.set_blendshape(
            FaceBlendShape.EyeSquintRight,
            1 - self._remap_blendshape(FaceBlendShape.EyeSquintRight, squint_right),
            no_filter,
        )

        right_brow_lower = (
            self._get_landmark(
                self.blend_shape_config.CanonicalPpoints.right_brow_lower[0]
            )
            + self._get_landmark(
                self.blend_shape_config.CanonicalPpoints.right_brow_lower[1]
            )
            + self._get_landmark(
                self.blend_shape_config.CanonicalPpoints.right_brow_lower[2]
            )
        ) / 3
        right_brow_dist = math.dist(
            self._get_landmark(self.blend_shape_config.CanonicalPpoints.right_brow),
            right_brow_lower,
        )

        left_brow_lower = (
            self._get_landmark(
                self.blend_shape_config.CanonicalPpoints.left_brow_lower[0]
            )
            + self._get_landmark(
                self.blend_shape_config.CanonicalPpoints.left_brow_lower[1]
            )
            + self._get_landmark(
                self.blend_shape_config.CanonicalPpoints.left_brow_lower[2]
            )
        ) / 3
        left_brow_dist = math.dist(
            self._get_landmark(self.blend_shape_config.CanonicalPpoints.left_brow),
            left_brow_lower,
        )

        self._live_link_face.set_blendshape(
            FaceBlendShape.BrowDownLeft,
            1 - self._remap_blendshape(FaceBlendShape.BrowDownLeft, left_brow_dist),
            no_filter,
        )
        self._live_link_face.set_blendshape(
            FaceBlendShape.BrowOuterUpLeft,
            self._remap_blendshape(FaceBlendShape.BrowOuterUpLeft, left_brow_dist),
            no_filter,
        )

        self._live_link_face.set_blendshape(
            FaceBlendShape.BrowDownRight,
            1 - self._remap_blendshape(FaceBlendShape.BrowDownRight, right_brow_dist),
            no_filter,
        )
        self._live_link_face.set_blendshape(
            FaceBlendShape.BrowOuterUpRight,
            self._remap_blendshape(FaceBlendShape.BrowOuterUpRight, right_brow_dist),
            no_filter,
        )

        inner_brow = self._get_landmark(
            self.blend_shape_config.CanonicalPpoints.inner_brow
        )
        upper_nose = self._get_landmark(
            self.blend_shape_config.CanonicalPpoints.upper_nose
        )
        ...
        cheek_squint_left = math.dist(
            self._get_landmark(
                self.blend_shape_config.CanonicalPpoints.cheek_squint_left[0]
            ),
            self._get_landmark(
                self.blend_shape_config.CanonicalPpoints.cheek_squint_left[1]
            ),
        )

        cheek_squint_right = math.dist(
            self._get_landmark(
                self.blend_shape_config.CanonicalPpoints.cheek_squint_right[0]
            ),
            self._get_landmark(
                self.blend_shape_config.CanonicalPpoints.cheek_squint_right[1]
            ),
        )
        ...
        self._live_link_face.set_blendshape(
            ...
            1
            - self._remap_blendshape(FaceBlendShape.CheekSquintLeft, cheek_squint_left),
            no_filter,
        )
        self._live_link_face.set_blendshape(
            ...
            1
            - self._remap_blendshape(
                FaceBlendShape.CheekSquintRight, cheek_squint_right
            ),
            no_filter,
        )
        ...
        self._live_link_face.set_blendshape(
            ...
            self._live_link_face.get_blendshape(FaceBlendShape.CheekSquintLeft),
            no_filter,
        )
        self._live_link_face.set_blendshape(
            FaceBlendShape.NoseSneerRight,
            self._live_link_face.get_blendshape(FaceBlendShape.CheekSquintRight),
            no_filter,
        )
